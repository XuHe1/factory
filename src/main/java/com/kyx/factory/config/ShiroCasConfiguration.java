...
public class ShiroCasConfiguration {
    ...
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean) {
        ...
        filterChainDefinitionMap.put("/images/**", "anon");//可以将不需要拦截的静态文件目录加进去
        filterChainDefinitionMap.put("/js/**", "anon");//可以将不需要拦截的静态文件目录加进去
        // api
        filterChainDefinitionMap.put("/product", "anon");
        filterChainDefinitionMap.put("/order/user", "anon");
        filterChainDefinitionMap.put("/sn_range/**", "anon");
